...
proginf = "figdict 0.1, jun 2017 mn"
import sys
import os
...
"return":-2, "randint":2, "topwr":1, "arr":0, "dict":0, "mod":1, "cos":0, 
...
if not ".figd" in p.lower():
    ...
    #print "need an input file to do anything..."; print ; quit()
        ...
        print "using built-in demo source, translating to demo.figd.py..." ; print
        p = "demo.figd"
            ...
            if p.lstrip()[0] == "#":
                ...
                if not lnob(x, 0) == "figg":
                    ...
                    "next", "while", "wend"] + ["break", "pass"]: 
                        ...
                        outfilewrite(outb, chr(32) * atleast(0, indent) + 
                        "try: figlist = int(type(" + lnob(x, 0) + ") in (list, dict))\n")
