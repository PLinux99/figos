...
while 1: 
    ...
    if len(token) or len(ptoken):
        ...
        elif token in ["help", "pserver", "isoname", "minusname", "cat", "arrdo", "fsortplus", "fields"] and (bufpos == 1 or prevtoken == "|"): token = pyprefix + alexver + ".py --" + token ; x = 1
