...
proginf = "alex 1.5, jan 2018 mn"
# alex 1.4 was also this month; dec 2017 was supposed to be updated
try: import readline 
except: p = 0
import sys
import os
...
while 1: 
    ...
    if len(token) or len(ptoken):
        ...
        "cat", "arrdo", "fsortplus", "fields", "replace", "rainbow", "ascii", "isoplus", "noreps"] and (bufpos == 1 or prevtoken == "|"): token = pyprefix + alexver + ".py --" + token ; x = 1
