...
def ptrans(token, argu, alexhist, nl):
    ...
    if token.lower() == "clear": 
        return (chr(32) * alexatleast(0, indent) + "alexcls(0)" + nl) 
...
pcmds = ["cd", "while", "set", "clear", "locate"] # take priority no matter what files are found
