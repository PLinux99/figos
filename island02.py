...
proginf = "island 0.2, oct 2017 mn"
...
cmdhelp = [("chill seconds", "input (shared-line) wait for number of seconds before continuing with program")
...
cmds = {"color":-4, "chill":-2, "write":-2, "erase":-1}
